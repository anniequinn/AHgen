#' @colsBaseline A vector of one colour for baseline scenarios.
#' 
#' @colsFloodRiver100 A vector of one colour for scenarios relating to 
#' river floods with a 1 in 100-year return period 
#' (i.e. standard of England's Environment Agency).
#' 
#' @colsFloodRiver200 A vector of one colour for scenarios relating to 
#' river floods with a 1 in 200-year return period 
#' (i.e. standard of Scotland's Scotland Environment Protection Agency).
#' 
#' @colsFloodRiver A vector of three colours for scenarios relating to 
