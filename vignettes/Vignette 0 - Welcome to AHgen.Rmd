...
4. **Analyse** Applying network analysis, summarising outputs, and comparing Abstraction Hierarchies
5. **Visualise** Visualising the Abstraction Hierarchy and results

```{r, echo = FALSE}
htmltools::img(src = knitr::image_uri("images/workflow-clean.png"), 
               alt = 'workflow-clean', width = 700)
```
...
Six walkthrough vignettes are provided to illustrate the application of AHgen to create and explore the Urban Systems Abstraction Hierarchy (USAH).
