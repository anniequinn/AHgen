...
```
There are five vignettes designed to get you on your way:
...
- Vignette 4 - [Analyse](Vignette-4---Analyse.html)
- Vignette 5 - [Visualise](Vignette-5---Visualise.html)
...
**Please cite** Visser-Quinn, A. & Bedinger, M. (2023). AHgen **v1.0.0**. Edinburgh, Scotland. https://doi.org/10.5281/zenodo.3975549 [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3975549.svg)](https://doi.org/10.5281/zenodo.3975549)
