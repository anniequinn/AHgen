---
title: "Application - Apply OSMtidy data"
author: 
...
In this vignette, you will go through the steps of applying `OSMtidy` data to generate a location-specific Urban Systems Abstraction Hierarchy in `AHgen`:
    ...
    2.0. - Check and edit the Resources to be excluded
    3.0. - Generate location-specific Urban Systems Abstraction Hierarchy
    4.0. - Export
...
geoData = 
  read_rds("inputs/OSMtidy_Bristol_20210826.RDS")
