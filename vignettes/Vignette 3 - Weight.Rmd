...
`AHgen` has two functions to simplify edge weighting for Abstraction Hierarchies: `weight_edges` and `weight_hangingVertices`.
...
### 4.3. A note on using `remove = FALSE`
