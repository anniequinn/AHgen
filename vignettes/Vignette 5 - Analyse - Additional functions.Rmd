...
- Section 4 - Comparing Abstraction Hierarchies
...
```{r}
# Inspect the edge list for the Bristol flood scenario
edgelist_Bristol_flood
...
## 4. Comparing Abstraction Hierarchies
...
<details><summary><span style = "color: #2196F3;">Example 7 - Compare Abstraction Hierarchies</span></summary>
```{r}
...
### 4.2. `summarise_confidence()`

The function `summarise_confidence()`...
...
<details><summary><span style = "color: #2196F3;">Example 8 - Summarise confidence of sensitivity analysis results</span></summary>
```{r}
